...
<head>
   ...
   <link href="<%=path%>/js/jquery/plugin/jquery-easyui/themes/default/eas0yui.css" type="text/css" >
   <link href="<%=path%>/js/jquery/plugin/jquery-easyui/themes/icon.css" type="text/css" >
   ...
   <style>
      ...
      .main-wrap1{margin-left: 0px;min-height:100%;}
      ...
      .insert-tab{border-collapse:collapse;border:none;}
      .insert-tab th,.insert-tab td{border:none;}
